...
const roleToStringMapping: { [key in Role]: string } = {
  ...
  [Role.WALLET_TRANSFER_ADMIN]: "Wallet Transfer Admin",
  [Role.WALLET_TRANSFER_VIEWER]: "Wallet Transfer Viewer",
  ...
  [Role.TESTING_LEDGER_TOKEN_TAP_ADMIN]: "Testing Ledger Token Tap Admin",
  [Role.TESTING_LEDGER_TOKEN_TAP_VIEWER]: "Testing Ledger Token Tap Viewer",
};
