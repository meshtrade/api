...
const stateToStringMapping: {
  ...
  [LimitOrderState.LIMIT_ORDER_STATE_UNSPECIFIED]: "-",
  [LimitOrderState.LIMIT_ORDER_STATE_SUBMISSION_IN_PROGRESS]:
    "Submission in Progress",
  [LimitOrderState.LIMIT_ORDER_STATE_SUBMISSION_FAILED]: "Submission Failed",
  [LimitOrderState.LIMIT_ORDER_STATE_OPEN]: "Open",
  [LimitOrderState.LIMIT_ORDER_STATE_COMPLETE_IN_PROGRESS]:
    "Complete in Progress",
  [LimitOrderState.LIMIT_ORDER_STATE_COMPLETE]: "Complete",
  [LimitOrderState.LIMIT_ORDER_STATE_CANCELLATION_IN_PROGRESS]:
    "Cancellation in Progress",
  [LimitOrderState.LIMIT_ORDER_STATE_CANCELLED]: "Cancelled",
};
