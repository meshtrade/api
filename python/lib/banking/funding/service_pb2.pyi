...
class ListResponse(_message.Message):
    __slots__ = ("funding",)
    FUNDING_FIELD_NUMBER: _ClassVar[int]
    funding: _containers.RepeatedCompositeFieldContainer[_funding_pb2.Funding]
    def __init__(self, funding: _Optional[_Iterable[_Union[_funding_pb2.Funding, _Mapping]]] = ...) -> None: ...
