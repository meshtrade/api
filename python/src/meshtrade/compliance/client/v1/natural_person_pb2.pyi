...
class NaturalPerson(_message.Message):
    __slots__ = ("full_name", "date_of_birth", "country_of_citizenship", "identification_number", "identification_document_type", "identification_document_expiry_date", "physical_address", "postal_address", "pep_status", "contact_details")
