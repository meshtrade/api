...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COMPANYREPRESENTATIVE']._serialized_start=280
  _globals['_COMPANYREPRESENTATIVE']._serialized_end=715
