...
class ConnectedLegalPerson(_message.Message):
    __slots__ = ("legal_person", "connection_types", "ownership_percentage", "voting_rights_percentage", "connection_descriptionn")
    ...
    CONNECTION_DESCRIPTIONN_FIELD_NUMBER: _ClassVar[int]
    ...
    connection_descriptionn: str
    def __init__(self, legal_person: _Optional[_Union[_legal_person_pb2.LegalPerson, _Mapping]] = ..., connection_types: _Optional[_Iterable[_Union[_legal_person_connection_type_pb2.LegalPersonConnectionType, str]]] = ..., ownership_percentage: _Optional[float] = ..., voting_rights_percentage: _Optional[float] = ..., connection_descriptionn: _Optional[str] = ...) -> None: ...
