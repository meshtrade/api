...
from .internal_authorization_service_pb2 import (
    AuthorizationStatus,
...
from .service_meshpy import (
    ...
    InternalAuthorizationServiceGRPCClient,
    InternalAuthorizationServiceGRPCClientInterface,
)
