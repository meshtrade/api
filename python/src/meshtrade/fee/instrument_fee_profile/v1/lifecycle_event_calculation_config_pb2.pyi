...
class LifecycleEventCalculationConfig(_message.Message):
    __slots__ = ("amount_lifecycle_event_calculation_config", "rate_lifecycle_event_calculation_config")
