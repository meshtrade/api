...
|--------|---------|-------------|
| `WithAddress(host, port)` | `production-service-mesh-api-gateway-lb-frontend.mesh.trade`, `443` | Custom host and port |
...
| Option | Default | Description |
|--------|---------|-------------|
| `url` | `production-service-mesh-api-gateway-lb-frontend.mesh.trade` | Host/endpoint |
