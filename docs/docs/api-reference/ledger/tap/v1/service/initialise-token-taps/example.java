import co.meshtrade.api.ledger.tap.v1.TapService;
import co.meshtrade.api.ledger.tap.v1.Service.InitialiseTokenTapsRequest;
import co.meshtrade.api.ledger.tap.v1.Service.InitialiseTokenTapsResponse;
...
public class InitialiseTokenTapsExample {
    public static void main(String[] args) {
        ...
        try (TapService service = new TapService()) {
