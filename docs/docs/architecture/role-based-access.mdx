...
graph TD
    subgraph "Business Domain Roles"
        ...
        subgraph "Issuance Hub Domain"
            IssuanceAdmin["👤 ROLE_ISSUANCE_HUB_ADMIN<br/>Asset issuance"]
            IssuanceViewer["👁️ ROLE_ISSUANCE_HUB_VIEWER<br/>Issuance read access"]
        end
...
**Issuance Hub Domain:**
- **General**: `ROLE_ISSUANCE_HUB_ADMIN` 👤, `ROLE_ISSUANCE_HUB_VIEWER` 👁️  
- **Specialized**: *(Future expansion planned)*
