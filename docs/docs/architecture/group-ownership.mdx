...
graph TD
    subgraph "Group Ownership Fields"
        Root["Root Group<br/>name: groups/01ABC123...XYZ<br/>owner: groups/01ABC123...XYZ (self)"]
        
        CompanyA["Company A Group<br/>name: groups/01DEF456...ABC<br/>owner: groups/01ABC123...XYZ"]
        
        TeamX["Team X Group<br/>name: groups/01GHI789...DEF<br/>owner: groups/01DEF456...ABC"]
        
        Account["User Account<br/>name: accounts/01JKL012...GHI<br/>owner: groups/01GHI789...DEF"]
...
graph TD
    subgraph "Universal Ownership Model"
        ...
        RegUser1["👤 Regular User 1<br/>users/01USER...ABC<br/>Auth: Username/Password"]
        ApiUser1["🔑 API User 1<br/>api_users/01API...PQR<br/>Auth: API Key"]
        
        RegUser2["👤 Regular User 2<br/>users/01USER...DEF<br/>Auth: Google OAuth"]
        ApiUser2["🔑 API User 2<br/>api_users/01API...STU<br/>Auth: API Key"]
        
        Account1["💰 Trading Account<br/>accounts/01ACC...VWX"]
        Account2["💰 Settlement Account<br/>accounts/01ACC...YZA"]
        
        Order1["📊 Limit Order<br/>orders/01ORD...BCD<br/>Created by: Regular User"]
        Order2["📊 Market Order<br/>orders/01ORD...EFG<br/>Created by: API User"]
...
graph TD
    subgraph "Read: Hierarchical Scope"
        ...
        Res1["📊 Resource 1<br/>owner: COMP_A<br/>✅ Accessible"]
        Res2["📊 Resource 2<br/>owner: TEAM_X<br/>✅ Accessible"]
        Res3["📊 Resource 3<br/>owner: TEAM_Y<br/>✅ Accessible"]
        Res4["📊 Resource 4<br/>owner: OTHER_COMP<br/>❌ Not Accessible"]
...
graph TD
    subgraph "Brokerage Platform with Legal Entity Structure"
        Mesh["🏢 Mesh Platform (Legal Entity)<br/>groups/MESH_ROOT<br/>📋 Compliance Entity: Platform Provider"]
        MeshClient["🏛️ Mesh Client Entity<br/>clients/MESH_CLIENT<br/>📋 Legal Status: Corporation"]
        
        BrokerA["🏦 Broker A Corporation<br/>groups/BROKER_A<br/>📋 KYC'd by: Mesh Platform"]
        BrokerAClient["🏢 Broker A Client Entity<br/>clients/BROKER_A_CLIENT<br/>📋 Legal Status: Financial Services Corp"]
        
        BrokerB["🏦 Broker B LLC<br/>groups/BROKER_B<br/>📋 KYC'd by: Mesh Platform"]
        BrokerBClient["🏢 Broker B Client Entity<br/>clients/BROKER_B_CLIENT<br/>📋 Legal Status: Limited Liability Company"]
        
        ClientA1["👤 Individual Client A1<br/>groups/CLIENT_A1<br/>📋 KYC'd by: Broker A"]
        ClientA1Entity["👤 Client A1 Entity<br/>clients/CLIENT_A1_ENTITY<br/>📋 Legal Status: Natural Person"]
        A1RegUser["👤 John Smith (Regular User)<br/>users/JOHN_SMITH<br/>📋 Auth: Username/Password<br/>📋 Role: Individual Trader"]
        A1ApiUser["🔑 John's Trading Bot (API User)<br/>api_users/JOHN_BOT<br/>📋 Auth: API Key<br/>📋 Role: Automated Trading"]
        
        ClientA2["🏢 Corporate Client A2<br/>groups/CLIENT_A2<br/>📋 KYC'd by: Broker A"]
        ClientA2Entity["🏢 Client A2 Entity<br/>clients/CLIENT_A2_ENTITY<br/>📋 Legal Status: Investment Company"]
        A2RegUser["👤 Sarah Johnson (Regular User)<br/>users/SARAH_JOHNSON<br/>📋 Auth: Google OAuth<br/>📋 Role: Portfolio Manager"]
        A2ApiUser["🔑 Corp Risk System (API User)<br/>api_users/CORP_RISK<br/>📋 Auth: API Key<br/>📋 Role: Risk Monitoring"]
        
        ClientB1["🏛️ Trust Client B1<br/>groups/CLIENT_B1<br/>📋 KYC'd by: Broker B"]
        ClientB1Entity["🏛️ Client B1 Entity<br/>clients/CLIENT_B1_ENTITY<br/>📋 Legal Status: Family Trust"]
        B1RegUser["👤 Trust Manager (Regular User)<br/>users/TRUST_MGR<br/>📋 Auth: SSO/SAML<br/>📋 Role: Trust Administrator"]
        
        AccA1["💰 Individual Trading Account<br/>accounts/ACC_A1_MAIN<br/>owner: CLIENT_A1"]
        
        AccA2["💰 Corporate Trading Account<br/>accounts/ACC_A2_TRADE<br/>owner: CLIENT_A2"]
        
        AccB1["💰 Trust Settlement Account<br/>accounts/ACC_B1_SETTLE<br/>owner: CLIENT_B1"]
        
        OrderA1["📊 Individual Buy Order<br/>orders/ORDER_BUY_123<br/>owner: CLIENT_A1<br/>💡 Created via: Web Trading Interface"]
        
        OrderA2["📊 Automated Sell Order<br/>orders/ORDER_SELL_456<br/>owner: CLIENT_A2<br/>💡 Created via: API Integration"]
...
graph TD
    subgraph "Investment Bank Organizational Structure"
        Bank["🏛️ Goldman Sachs International<br/>groups/GOLDMAN_INTL<br/>📋 Legal Entity: Investment Bank"]
        BankClient["🏢 Goldman Client Entity<br/>clients/GOLDMAN_CLIENT<br/>📋 Legal Status: Financial Institution"]
        
        subgraph "Fund Structures"
            AlphaFund["💼 Alpha Hedge Fund LP<br/>groups/ALPHA_FUND<br/>📋 Legal Entity: Limited Partnership<br/>📋 KYC'd by: Goldman Sachs"]
            AlphaFundClient["📊 Alpha Fund Client<br/>clients/ALPHA_FUND_CLIENT<br/>📋 Legal Status: Investment Vehicle"]
            
            BetaFund["💼 Beta Real Estate Fund<br/>groups/BETA_FUND<br/>📋 Legal Entity: REIT Corporation<br/>📋 KYC'd by: Goldman Sachs"]
            BetaFundClient["🏢 Beta Fund Client<br/>clients/BETA_FUND_CLIENT<br/>📋 Legal Status: REIT Corporation"]
        end
        
        subgraph "Alpha Fund Departments"
            AlphaResearch["🔬 Alpha Research Division<br/>groups/ALPHA_RESEARCH<br/>📋 Internal Department"]
            AlphaRisk["⚖️ Alpha Risk Management<br/>groups/ALPHA_RISK<br/>📋 Internal Department"]
        end
        
        subgraph "Trading Desks"
            BondDesk["📈 Fixed Income Desk<br/>groups/BOND_DESK<br/>📋 Trading Department<br/>📋 Specialization: Government & Corporate Bonds"]
            ForexDesk["💱 Foreign Exchange Desk<br/>groups/FOREX_DESK<br/>📋 Trading Department<br/>📋 Specialization: Currency Trading"]
            MetalsDesk["🥇 Precious Metals Desk<br/>groups/METALS_DESK<br/>📋 Trading Department<br/>📋 Specialization: Gold, Silver, Commodities"]
        end
        
        subgraph "Users & System Access"
            BondTrader["👤 Bond Trader (Regular User)<br/>users/BOND_TRADER_001<br/>📋 Auth: SSO/Active Directory<br/>📋 Access: Trading Terminal"]
            BondTradingBot["🔑 Bond Algo System (API User)<br/>api_users/BOND_ALGO<br/>📋 Auth: API Key<br/>📋 Access: Automated Trading"]
            
            ForexAnalyst["👤 FX Analyst (Regular User)<br/>users/FX_ANALYST_001<br/>📋 Auth: Username/Password<br/>📋 Access: Risk Dashboard"]
            ForexPricingAPI["🔑 FX Pricing Feed (API User)<br/>api_users/FX_PRICING<br/>📋 Auth: API Key<br/>📋 Access: Market Data"]
            
            MetalsManager["👤 Metals Desk Head (Regular User)<br/>users/METALS_HEAD<br/>📋 Auth: Smart Card + PIN<br/>📋 Access: Management Console"]
        end
        
        subgraph "Accounts & Trading Activity"
            AlphaFundAcc["💰 Alpha Fund Master Account<br/>accounts/ALPHA_MASTER_ACC<br/>owner: ALPHA_FUND<br/>Balance: $500M"]
            
            BetaFundAcc["💰 Beta Fund Property Account<br/>accounts/BETA_PROPERTY_ACC<br/>owner: BETA_FUND<br/>Balance: $200M"]
            
            AlphaResearchAcc["💰 Research Analysis Account<br/>accounts/ALPHA_RESEARCH_ACC<br/>owner: ALPHA_RESEARCH<br/>Balance: $5M"]
            
            BondDeskAcc["💰 Bond Trading Account<br/>accounts/BOND_TRADING_ACC<br/>owner: BOND_DESK<br/>Balance: $50M"]
            
            ForexDeskAcc["💰 FX Trading Account<br/>accounts/FOREX_TRADING_ACC<br/>owner: FOREX_DESK<br/>Balance: $75M"]
            
            MetalsDeskAcc["💰 Metals Trading Account<br/>accounts/METALS_TRADING_ACC<br/>owner: METALS_DESK<br/>Balance: $25M"]
            
            GoldTrade["📊 Gold Futures Order<br/>orders/GOLD_FUTURES_001<br/>owner: METALS_DESK<br/>Amount: $2M Long Position<br/>💡 Created by: Regular User via Terminal"]
            
            BondTrade["📊 Treasury Bond Order<br/>orders/TREASURY_BOND_001<br/>owner: BOND_DESK<br/>Amount: $10M 10-Year Notes<br/>💡 Created by: API Integration"]
            
            FXTrade["📊 EUR/USD Trade<br/>orders/EUR_USD_001<br/>owner: FOREX_DESK<br/>Amount: €5M Currency Swap<br/>💡 Created by: Regular User via Dashboard"]
        end
