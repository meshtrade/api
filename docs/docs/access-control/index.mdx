...
graph TD
    ...
    style Root fill:#e1f5fe,color:#1a1a1a
    style BrokerA fill:#c8e6c9,color:#1a1a1a
    style ClientX fill:#fff3e0,color:#1a1a1a
    style Account fill:#fce4ec,color:#1a1a1a
```
...
graph TD
    ...
    style Client fill:#e1f5fe,color:#1a1a1a
    style APIUser fill:#c8e6c9,color:#1a1a1a
    style Account fill:#fff3e0,color:#1a1a1a
```
...
graph TD
    ...
    style BrokerClient fill:#e1f5fe,color:#1a1a1a
    style CorpClient fill:#e1f5fe,color:#1a1a1a
    style IndClient fill:#e1f5fe,color:#1a1a1a
```
