...
The Mesh API provides programmatic access to Mesh's trading platform. Build trading applications, automate workflows, and integrate financial services into your platform.
...
:::info
See **[Resource Hierarchy Structure](/docs/architecture/resource-hierarchy)** for more information on group structures in Mesh.
:::
...
:::info
For more information about authentication see **[API Access](/docs/architecture/api-access)**.
:::
...
👉 **[Resource Hierarchy Guide](/docs/architecture/resource-hierarchy)** - Understand multi-tenancy, resource isolation, and group management

### 🔐 Permissions Structure
Discover our schema-driven authorization system and role-based access control.

👉 **[Roles & Permissions Guide](/docs/architecture/method-permissions)** - Master RBAC, roles, and permission management
