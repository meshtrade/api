...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| key_hash | [string](#string) |  | Key hash of the API user to get. |
...
| GetApiUserByKeyHash | [GetApiUserByKeyHashRequest](#meshtrade-iam-api_user-v1-GetApiUserByKeyHashRequest) | [APIUser](#meshtrade-iam-api_user-v1-APIUser) | Get API user by key hash. |
