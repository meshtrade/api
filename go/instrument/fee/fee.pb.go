...
func (x *Fee) GetVatAmount() string {
	if x != nil {
		return x.VatAmount
	}
	return ""
...
var file_instrument_fee_fee_proto_rawDesc = []byte{
	...
	0x22, 0xdd, 0x02, 0x0a, 0x03, 0x46, 0x65, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	0x75, 0x6e, 0x74, 0x49, 0x6e, 0x63, 0x6c, 0x56, 0x41, 0x54, 0x12, 0x1c, 0x0a, 0x09, 0x76, 0x61,
	0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x76,
...
var file_instrument_fee_fee_proto_depIdxs = []int32{
	...
	1, // 2: fee.Fee.category:type_name -> fee.Category
	4, // 3: fee.Fee.paymentDate:type_name -> google.protobuf.Timestamp
	5, // 4: fee.Fee.data:type_name -> fee.Data
