...
const file_instrument_fee_dataPerUnit_proto_rawDesc = "" +
	"\n" +
	" instrument/fee/dataPerUnit.proto\x12\x12api.instrument.fee\x1a\x13ledger/amount.proto\x1a\x11num/decimal.proto\"\xd9\x01\n" +
	"\vPerUnitData\x12*\n" +
...
var (
	...
	file_instrument_fee_dataPerUnit_proto_rawDescData []byte
)

func file_instrument_fee_dataPerUnit_proto_rawDescGZIP() []byte {
	file_instrument_fee_dataPerUnit_proto_rawDescOnce.Do(func() {
		file_instrument_fee_dataPerUnit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_instrument_fee_dataPerUnit_proto_rawDesc), len(file_instrument_fee_dataPerUnit_proto_rawDesc)))
	})
...
var file_instrument_fee_dataPerUnit_proto_goTypes = []any{
...
func file_instrument_fee_dataPerUnit_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_instrument_fee_dataPerUnit_proto_rawDesc), len(file_instrument_fee_dataPerUnit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
