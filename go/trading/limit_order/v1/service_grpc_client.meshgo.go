...
// LimitOrderServiceGRPCClient is a gRPC client for the LimitOrderService service.
...
type LimitOrderServiceGRPCClient interface {
	LimitOrderService
	common.GRPCClient
}

// ensure limitOrderServiceGRPCClient implements the LimitOrderServiceGRPCClient interface
var _ LimitOrderServiceGRPCClient = &limitOrderServiceGRPCClient{}

// limitOrderServiceGRPCClient is the internal implementation of the LimitOrderServiceGRPCClient interface.
...
// NewLimitOrderServiceGRPCClient creates a new gRPC client for the LimitOrderService service.
...
//
// Returns:
//   - LimitOrderServiceGRPCClient: Configured client instance
...
func NewLimitOrderServiceGRPCClient(opts ...ClientOption) (LimitOrderServiceGRPCClient, error) {
	// prepare client with default configuration
	client := &limitOrderServiceGRPCClient{
	...
	client.conn = conn
	client.grpcClient = NewLimitOrderServiceClient(conn)

	// return constructed client
	return client, nil
}

// GetLimitOrder executes the GetLimitOrder RPC method on the LimitOrderService service.
...
//   - request: The GetLimitOrderRequest containing the method parameters
//
// Returns:
//   - *LimitOrder: The successful response from the service
//   - error: Any error that occurred during the request
//
// Example:
//
//	resp, err := client.GetLimitOrder(ctx, &GetLimitOrderRequest{
//		// populate request fields
//	})
//	if err != nil {
//		return fmt.Errorf("getlimitorder failed: %w", err)
//	}
func (s *limitOrderServiceGRPCClient) GetLimitOrder(ctx context.Context, request *GetLimitOrderRequest) (*LimitOrder, error) {
	...
	getLimitOrderResponse, err := s.grpcClient.GetLimitOrder(ctx, request)
	if err != nil {
		return nil, err
	}
...
func (s *limitOrderServiceGRPCClient) Close() error {
	if s.conn != nil {
		return s.conn.Close()
	}
	return nil
...
func (s *limitOrderServiceGRPCClient) Group() string {
	return s.group
}
...
func (c *limitOrderServiceGRPCClient) validateAuth() error {
	if c.apiKey == "" {
...
func (c *limitOrderServiceGRPCClient) authInterceptor() grpc.UnaryClientInterceptor {
