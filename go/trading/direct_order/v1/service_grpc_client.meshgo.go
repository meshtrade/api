...
// DirectOrderServiceGRPCClient is a gRPC client for the DirectOrderService service.
...
// NewDirectOrderServiceGRPCClient creates a new gRPC client for the DirectOrderService service.
...
func (s *directOrderServiceGRPCClient) Group() string {
	return s.group
}
