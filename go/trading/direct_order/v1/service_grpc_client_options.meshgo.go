...
// ClientOption is a functional option for configuring the DirectOrderService gRPC client.
...
type ClientOption func(*directOrderServiceGRPCClient)
...
func WithTLS(enabled bool) ClientOption {
	return func(c *directOrderServiceGRPCClient) {
		c.tls = enabled
	}
}
...
// Example:
//
//	tracer := otel.Tracer("directorderservice-client")
//	client, err := NewDirectOrderServiceGRPCClient(
//	    WithTracer(tracer),
//	)
