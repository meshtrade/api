...
// ClientOption is a functional option for configuring the SpotService gRPC client.
...
type ClientOption func(*spotServiceGRPCClient)
...
func WithTLS(enabled bool) ClientOption {
	return func(c *spotServiceGRPCClient) {
		c.tls = enabled
	}
}
...
// Example:
//
//	tracer := otel.Tracer("spotservice-client")
//	client, err := NewSpotServiceGRPCClient(
//	    WithTracer(tracer),
//	)
