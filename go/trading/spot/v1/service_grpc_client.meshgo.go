...
// SpotServiceGRPCClient is a production-ready gRPC client for the SpotService service.
...
type SpotServiceGRPCClient interface {
	SpotService
	common.GRPCClient
}

// ensure spotServiceGRPCClient implements the SpotServiceGRPCClient interface
var _ SpotServiceGRPCClient = &spotServiceGRPCClient{}

// spotServiceGRPCClient is the internal implementation of the SpotServiceGRPCClient interface.
...
// NewSpotServiceGRPCClient creates a new production-ready gRPC client for the SpotService service.
...
//
// Returns:
//   - SpotServiceGRPCClient: Configured client instance
...
func NewSpotServiceGRPCClient(opts ...ClientOption) (SpotServiceGRPCClient, error) {
	// prepare client with default configuration
	client := &spotServiceGRPCClient{
	...
	client.conn = conn
	client.grpcClient = NewSpotServiceClient(conn)

	// return constructed client
	return client, nil
}

// GetSpot executes the GetSpot RPC method on the SpotService service.
...
//   - request: The GetSpotRequest containing the method parameters
//
// Returns:
//   - *Spot: The successful response from the service
//   - error: Any error that occurred during the request
//
// Example:
//
//	resp, err := client.GetSpot(ctx, &GetSpotRequest{
//		// populate request fields
//	})
//	if err != nil {
//		return fmt.Errorf("getspot failed: %w", err)
//	}
func (s *spotServiceGRPCClient) GetSpot(ctx context.Context, request *GetSpotRequest) (*Spot, error) {
	...
	getSpotResponse, err := s.grpcClient.GetSpot(ctx, request)
	if err != nil {
		return nil, err
	}
...
func (s *spotServiceGRPCClient) Close() error {
	if s.conn != nil {
		return s.conn.Close()
	}
	return nil
...
func (c *spotServiceGRPCClient) authInterceptor() grpc.UnaryClientInterceptor {
	if c.apiKey != "" {
