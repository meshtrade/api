...
//
// Full Service documentation: https://meshtrade.github.io/api/docs/api-reference/trading/spot/v1
//
...
// NewSpotService creates and initializes the SpotService service.
