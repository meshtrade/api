...
// ClientOption is a functional option for configuring the AccountService gRPC client.
...
type ClientOption func(*accountServiceGRPCClient)
...
func WithTLS(enabled bool) ClientOption {
	return func(c *accountServiceGRPCClient) {
		c.tls = enabled
	}
}
...
// Example:
//
//	tracer := otel.Tracer("accountservice-client")
//	client, err := NewAccountServiceGRPCClient(
//	    WithTracer(tracer),
//	)
