...
// AccountServiceGRPCClient is a gRPC client for the AccountService service.
...
// NewAccountServiceGRPCClient creates a new gRPC client for the AccountService service.
...
func (s *accountServiceGRPCClient) Group() string {
	return s.group
}
