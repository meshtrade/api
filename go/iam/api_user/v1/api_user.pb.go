...
const file_meshtrade_iam_api_user_v1_api_user_proto_rawDesc = "" +
	"\n" +
	"(meshtrade/iam/api_user/v1/api_user.proto\x12\x19meshtrade.iam.api_user.v1\x1a\x1bbuf/validate/validate.proto\"\x97\x06\n" +
	...
	"\vstate.valid\x12/state must be a valid APIUserState if specified\x1a4int(this) == 0 || (int(this) >= 1 && int(this) <= 2)\x82\x01\x02\x10\x01R\x05state\x12b\n" +
	"\x05roles\x18\x06 \x03(\tBL\xbaHI\x92\x01F\"DrB2=^groups/[0123456789ABCDEFGHJKMNPQRSTVWXYZ]{26}/[1-9][0-9]{6}$\x98\x01)R\x05roles\x12\x17\n" +
