...
// ClientOption is a functional option for configuring the GroupService gRPC client.
...
type ClientOption func(*groupServiceGRPCClient)
...
func WithTLS(enabled bool) ClientOption {
	return func(c *groupServiceGRPCClient) {
		c.tls = enabled
	}
}
...
// Example:
//
//	tracer := otel.Tracer("groupservice-client")
//	client, err := NewGroupServiceGRPCClient(
//	    WithTracer(tracer),
//	)
