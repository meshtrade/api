...
func NewGroupService(opts ...ServiceOption) (GroupServiceClientInterface, error) {
	...
	service.conn = conn
	service.grpcClient = NewGroupServiceClient(conn)
...
// Example:
//
//	resp, err := service.GetGroup(ctx, &GetGroupRequest{
...
// Example:
//
//	resp, err := service.ListGroups(ctx, &ListGroupsRequest{
//		// populate request fields
//	})
//	if err != nil {
...
// Example:
//
//	resp, err := service.SearchGroups(ctx, &SearchGroupsRequest{
//		// populate request fields
//	})
//	if err != nil {
...
func (s *groupService) Group() string {
	return s.group
}
...
func (c *groupService) validateAuth() error {
	if c.apiKey == "" {
...
func (c *groupService) authInterceptor() grpc.UnaryClientInterceptor {
