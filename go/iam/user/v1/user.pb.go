...
const file_meshtrade_iam_user_v1_user_proto_rawDesc = "" +
	"\n" +
	" meshtrade/iam/user/v1/user.proto\x12\x15meshtrade.iam.user.v1\x1a\x1bbuf/validate/validate.proto\"\x9d\x03\n" +
	"\x04User\x12\xba\x01\n" +
	...
	"\xbaH\a\xc8\x01\x01r\x02`\x01R\x05email\x12b\n" +
	"\x05roles\x18\x06 \x03(\tBL\xbaHI\x92\x01F\"DrB2=^groups/[0123456789ABCDEFGHJKMNPQRSTVWXYZ]{26}/[1-9][0-9]{6}$\x98\x01)R\x05rolesBO\n" +
