...
const (
	...
	Role_ROLE_REPORT_VIEWER       Role = 4000
)
...
const file_meshtrade_iam_role_v1_role_proto_rawDesc = "" +
	...
	"\bRoleList\x121\n" +
	"\x05roles\x18\x01 \x03(\x0e2\x1b.meshtrade.iam.role.v1.RoleR\x05roles*\xb0\x02\n" +
	"\x04Role\x12\x14\n" +
	...
	"\x12\x17\n" +
	"\x12ROLE_REPORT_VIEWER\x10\xa0\x1f:f\n" +
