...
const file_meshtrade_iam_user_profile_v1_user_profile_proto_rawDesc = "" +
	"\n" +
	"0meshtrade/iam/user_profile/v1/user_profile.proto\x12\x1dmeshtrade.iam.user_profile.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1dmeshtrade/type/v1/token.proto\"\xd0\n" +
	"\n" +
	...
	"\n" +
	"first_name\x18\a \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\tfirstName\x12#\n" +
	"\tlast_name\x18\b \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\blastName\x12C\n" +
