...
// ClientOption is a functional option for configuring the InstrumentService gRPC client.
...
type ClientOption func(*instrumentServiceGRPCClient)
...
func WithTLS(enabled bool) ClientOption {
	return func(c *instrumentServiceGRPCClient) {
		c.tls = enabled
	}
}
...
// Example:
//
//	tracer := otel.Tracer("instrumentservice-client")
//	client, err := NewInstrumentServiceGRPCClient(
//	    WithTracer(tracer),
//	)
