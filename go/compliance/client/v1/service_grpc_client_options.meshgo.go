...
// ClientOption is a functional option for configuring the ClientService gRPC client.
...
type ClientOption func(*clientServiceGRPCClient)
...
func WithTLS(enabled bool) ClientOption {
	return func(c *clientServiceGRPCClient) {
		c.tls = enabled
	}
}
...
// Example:
//
//	tracer := otel.Tracer("clientservice-client")
//	client, err := NewClientServiceGRPCClient(
//	    WithTracer(tracer),
//	)
