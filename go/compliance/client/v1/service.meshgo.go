...
func NewClientService(opts ...ServiceOption) (ClientServiceClientInterface, error) {
	...
	service.conn = conn
	service.grpcClient = NewClientServiceClient(conn)
...
// Example:
//
//	resp, err := service.CreateClient(ctx, &CreateClientRequest{
...
// Example:
//
//	resp, err := service.GetClient(ctx, &GetClientRequest{
//		// populate request fields
//	})
//	if err != nil {
...
// Example:
//
//	resp, err := service.ListClients(ctx, &ListClientsRequest{
//		// populate request fields
//	})
//	if err != nil {
...
func (s *clientService) Group() string {
	return s.group
}
...
func (c *clientService) validateAuth() error {
	if c.apiKey == "" {
...
func (c *clientService) authInterceptor() grpc.UnaryClientInterceptor {
