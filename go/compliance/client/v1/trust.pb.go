...
func (x *Trust) Reset() {
	*x = Trust{}
	mi := &file_meshtrade_compliance_client_v1_trust_proto_msgTypes[0]
...
func (*Trust) Descriptor() ([]byte, []int) {
	return file_meshtrade_compliance_client_v1_trust_proto_rawDescGZIP(), []int{0}
}

func (x *Trust) GetRegisteredName() string {
	if x != nil {
...
func (x *Trust) GetRegistrationNumber() string {
	if x != nil {
...
func (x *Trust) GetDateOfInception() *date.Date {
	if x != nil {
...
var File_meshtrade_compliance_client_v1_trust_proto protoreflect.FileDescriptor
...
var (
	...
	file_meshtrade_compliance_client_v1_trust_proto_rawDescData []byte
)

func file_meshtrade_compliance_client_v1_trust_proto_rawDescGZIP() []byte {
	file_meshtrade_compliance_client_v1_trust_proto_rawDescOnce.Do(func() {
		file_meshtrade_compliance_client_v1_trust_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_meshtrade_compliance_client_v1_trust_proto_rawDesc), len(file_meshtrade_compliance_client_v1_trust_proto_rawDesc)))
	})
	return file_meshtrade_compliance_client_v1_trust_proto_rawDescData
}
...
func file_meshtrade_compliance_client_v1_trust_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_meshtrade_compliance_client_v1_trust_proto_rawDesc), len(file_meshtrade_compliance_client_v1_trust_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_meshtrade_compliance_client_v1_trust_proto_goTypes,
		DependencyIndexes: file_meshtrade_compliance_client_v1_trust_proto_depIdxs,
		MessageInfos:      file_meshtrade_compliance_client_v1_trust_proto_msgTypes,
	}.Build()
	File_meshtrade_compliance_client_v1_trust_proto = out.File
	file_meshtrade_compliance_client_v1_trust_proto_goTypes = nil
	file_meshtrade_compliance_client_v1_trust_proto_depIdxs = nil
}
