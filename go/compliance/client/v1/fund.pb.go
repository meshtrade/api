...
func (x *Fund) GetTaxResidencies() []*TaxResidency {
	if x != nil {
...
const file_meshtrade_compliance_client_v1_fund_proto_rawDesc = "" +
	"\n" +
	")meshtrade/compliance/client/v1/fund.proto\x12\x1emeshtrade.compliance.client.v1\x1a\x1bbuf/validate/validate.proto\x1a\x16google/type/date.proto\x1a2meshtrade/compliance/client/v1/tax_residency.proto\"\xe0\x03\n" +
	"\x04Fund\x121\n" +
...
var file_meshtrade_compliance_client_v1_fund_proto_depIdxs = []int32{
	1, // 0: meshtrade.compliance.client.v1.Fund.tax_residencies:type_name -> meshtrade.compliance.client.v1.TaxResidency
	2, // 1: meshtrade.compliance.client.v1.Fund.date_of_inception:type_name -> google.type.Date
