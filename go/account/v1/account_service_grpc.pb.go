...
const (
	Service_GetAccount_FullMethodName = "/meshtrade.account.v1.Service/GetAccount"
)
...
type ServiceClient interface {
	// GetAccount retrieves a single account by its unique number.
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "meshtrade/account/v1/account_service.proto",
}
