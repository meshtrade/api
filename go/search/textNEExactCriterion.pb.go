...
type TextNEExactCriterion struct {
...
func (x *TextNEExactCriterion) String() string {
...
func (x *TextNEExactCriterion) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
var file_api_proto_search_textNEExactCriterion_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x2f, 0x74, 0x65, 0x78, 0x74, 0x4e, 0x45, 0x45, 0x78, 0x61, 0x63, 0x74, 0x43, 0x72,
	...
	0x52, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x42, 0x24, 0x5a, 0x22, 0x67,
...
var (
	...
	file_api_proto_search_textNEExactCriterion_proto_rawDescData = file_api_proto_search_textNEExactCriterion_proto_rawDesc
)
...
func file_api_proto_search_textNEExactCriterion_proto_rawDescGZIP() []byte {
	file_api_proto_search_textNEExactCriterion_proto_rawDescOnce.Do(func() {
		file_api_proto_search_textNEExactCriterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_proto_search_textNEExactCriterion_proto_rawDescData)
	})
...
var file_api_proto_search_textNEExactCriterion_proto_goTypes = []interface{}{
...
func file_api_proto_search_textNEExactCriterion_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_proto_search_textNEExactCriterion_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TextNEExactCriterion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_proto_search_textNEExactCriterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_proto_search_textNEExactCriterion_proto_rawDesc = nil
