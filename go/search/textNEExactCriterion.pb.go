...
var file_search_textNEExactCriterion_proto_rawDesc = []byte{
	0x0a, 0x21, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x2f, 0x74, 0x65, 0x78, 0x74, 0x4e, 0x45, 0x45,
...
var (
	...
	file_search_textNEExactCriterion_proto_rawDescData = file_search_textNEExactCriterion_proto_rawDesc
)

func file_search_textNEExactCriterion_proto_rawDescGZIP() []byte {
	file_search_textNEExactCriterion_proto_rawDescOnce.Do(func() {
		file_search_textNEExactCriterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_search_textNEExactCriterion_proto_rawDescData)
	})
...
var file_search_textNEExactCriterion_proto_goTypes = []interface{}{
	(*TextNEExactCriterion)(nil), // 0: search.TextNEExactCriterion
}
...
func file_search_textNEExactCriterion_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_search_textNEExactCriterion_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_search_textNEExactCriterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_search_textNEExactCriterion_proto_rawDesc = nil
