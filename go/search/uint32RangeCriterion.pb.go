...
const file_search_uint32RangeCriterion_proto_rawDesc = "" +
	"\n" +
	"!search/uint32RangeCriterion.proto\x12\n" +
...
var (
	...
	file_search_uint32RangeCriterion_proto_rawDescData []byte
)

func file_search_uint32RangeCriterion_proto_rawDescGZIP() []byte {
	file_search_uint32RangeCriterion_proto_rawDescOnce.Do(func() {
		file_search_uint32RangeCriterion_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_search_uint32RangeCriterion_proto_rawDesc), len(file_search_uint32RangeCriterion_proto_rawDesc)))
	})
...
var file_search_uint32RangeCriterion_proto_goTypes = []any{
...
func file_search_uint32RangeCriterion_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_search_uint32RangeCriterion_proto_rawDesc), len(file_search_uint32RangeCriterion_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
