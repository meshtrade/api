...
class UnsupportedLifecycleEventCalculationConfigTypeError extends Error {
    ...
    constructor(lifecycleEventCalculationConfigType: LifecycleEventCalculationConfigType) {
...
export function stringToLifecycleEventCalculationConfigType(
    ...
    if (
        lifecycleEventCalculationConfigTypeStr in stringToLifecycleEventCalculationConfigTypeMapping
    ) {
