...
import { file_instrument_fee_data } from "./data_pb";
 ...
 */
export const file_instrument_fee_fee: GenFile = /*@__PURE__*/
  fileDesc("", [file_instrument_fee_data, file_ledger_amount, file_google_protobuf_timestamp]);
...
export const FeeSchema: GenMessage<Fee> = /*@__PURE__*/
  messageDesc(file_instrument_fee_fee, 0);
...
export const StateSchema: GenEnum<State> = /*@__PURE__*/
  enumDesc(file_instrument_fee_fee, 0);
...
export const CategorySchema: GenEnum<Category> = /*@__PURE__*/
  enumDesc(file_instrument_fee_fee, 1);
