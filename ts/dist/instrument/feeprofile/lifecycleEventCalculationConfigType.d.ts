...
export declare const allLifecycleEventCalculationConfigTypes: LifecycleEventCalculationConfigType[];
/**
 ...
 */
export declare function lifecycleEventCalculationConfigTypeToString(lifecycleEventCalculationConfigType: LifecycleEventCalculationConfigType): string;
/**
 ...
 */
export declare function stringToLifecycleEventCalculationConfigType(lifecycleEventCalculationConfigTypeStr: string): LifecycleEventCalculationConfigType;
